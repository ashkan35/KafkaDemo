...
k6 run user-logged-in-kafka-5000rps.js
...
k6 run KafkaDemo\k6\user-logged-in-kafka-5000rps.js
...
```powershell
k6 run -e RPS=5000 -e DURATION=2m -e PRE_ALLOCATED_VUS=1000 -e MAX_VUS=5000 KafkaDemo\k6\user-logged-in-kafka-5000rps.js
```
